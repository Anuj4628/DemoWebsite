...
export const aboutIntroData = {
  eyebrow: "ABOUT REDCORE STEELS",
  headlineLine1: "BUILT ON STEEL.",
  headlineLine2: "DRIVEN BY TRUST.",
  lead: "For over two decades, Redcore Steels has stood at the forefront of high-performance metallurgy, engineering excellence, and international steel supply chains.",
...
export const aboutLeadershipData = {
  ...
  lead: "Founded on unwavering integrity and deep metallurgical discipline, Redcore Steels operates as a high-velocity partner for critical engineering sectors worldwide.",
  pillars: [
...
export const aboutCTAData = {
  ...
  secondaryAction: { label: "Call Export Desk", href: "tel:+919000000000" }
};
